...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="max-h-[100vh] min-h-[140vh] lg:min-h-[200vh] flex flex-col items-center py-1 lg:py-16 justify-start flex-shrink-0 [perspective:800px] transform lg:scale-100 scale-50"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-7xl lg:text-5xl mb-20 lg:mb-28 font-bold lg:text-center"
      >
        {title || (
          <span>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[40rem] mt-10 absolute inset-0 bg-[#010101] rounded-2xl -left-14 p-2"
      >
